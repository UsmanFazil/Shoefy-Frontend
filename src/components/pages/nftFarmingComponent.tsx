...
class nftFarmingComponent extends BaseComponent<StakingProps & WithTranslation, StakingState> {
							...
							<ul role="tablist" className="nav nav-tabs" style={{ padding: "10px", paddingBottom: "0" }}>
								...
								<FadeInLeftDiv className="col-md-12 d-flex">
									<div className="shadow d-flex flex-column flex-fill gradient-card primary user-info">
										<h1 className="user-info-title">General VS Staking Farming</h1>
...
const FarmingComponentMain = compose(
	withWallet,
)(FarmComponentWithTranlation);
